...
Sentry Drone Turrets have the \textbf{Autonomous Defence}, \textbf{Turret}, \textbf{Integral Armour}, \textbf{Drone}, and \textbf{Deep Strike (2)} abilities.
...
Hammerheads have the \textbf{Antigrav} ability. Their main weapon has the \textbf{Turret} ability; in addition the Railgun of the Mk II variant has the \textbf{Damage (+1)} ability, and the Missile Rack of the Mk III uses \textbf{Artillery} and \textbf{Reduces Cover ($-1$)}. Finally the missiles of the Mk II, IV, and VI variants have the \textbf{Smart Missiles} ability.
...
The Sky Ray has the \textbf{Antigrav}, \textbf{Markerlight (75 cm)}, and \textbf{Seeker Missiles} abilities. Its weapon has the \textbf{AA} ability.
...
The Stingray has the \textbf{Antigrav} and \textbf{Seeker Missiles} abilities. The Submunition Missiles use a \textbf{Template (7.5 cm)} that \textbf{Reduces Cover ($-1$)} and have the \textbf{Battery} ability; the Smart Missiles have the \textbf{Smart Missiles} ability.
