...
A detachment that loses at least half of its current bases or Wounds as the result of a single action, either an assault or the resolution of a shooting attack, becomes \textit{Affected}.
...
A Broken formation awards its Destruction Point value to the opponent. These points are used in certain scenarios.
