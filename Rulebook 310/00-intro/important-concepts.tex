...
\begin{description}
    ...
    \item[Template:] A game component, usually circular, used to represent the area of effect of certain weapons or abilities. The main templates are:
\end{description}

\begin{itemize}
    \item \textbf{7.5~cm:} a circular 3-inch template.
    \item \textbf{12~cm:} a circular 5-inch template.
    \item \textbf{Flame:} a teardrop-shaped template, 8.2 inches long and 2.4 inches wide.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Class 4:} Super-heavies and Knights
...
The interdiction zone represents a base's long-range threat and affects certain aspects of the game for opposing bases, such as morale. It extends 25~cm around the base. A base does not generate an interdiction zone if it has a Fall Back order, is at altitude, or is pinned in an assault.
...
Tactical Space Marines therefore have a Movement of 10~cm, a Save of 5+, an Assault Factor of $+2$, a Morale of 5, and Bolters with a Range of 45~cm, 1 attack die per base, a To-Hit of 5+, and no Armour Penetration.
